...
# A: Create a county list and county votes dictionary.
ballot_measure_topics = []
ballot_measure_votes = {}

#B: make a list of column Names
list_column_names = []
...
with open(file_to_load) as election_data:
    ...
    # C: add names of columns to list 
    for row in reader:
        list_column_names.append(row)
        break
    print(list_column_names[0])
    print(list_column_names)
    
    # D: get ballot measure column
    print('TEST')
    for i in list_column_names:
        for j in i:
            if j == "Ballot ID":
                print(f'{j} is NOT a ballot measure')
            elif j == "County":
                print(f'{j} is NOT a ballot measure')
            elif j == "Candidate":
                print(f'{j} is NOT a ballot measure')    
            else:
                ballot_measure_topics.append(j)
    print(ballot_measure_topics)
